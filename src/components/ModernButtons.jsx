    ...
    <div className="flex flex-wrap gap-4 p-6 mb-4 bg-gray-100 rounded-lg">
      <button 
        ...
        <div className="flex flex-col items-center relative z-10 transition-all duration-300 group-hover:transform group-hover:translate-y-2">
          ...
          <p className="font-medium text-gray-800 group-hover:text-white transition-colors duration-300">All</p>
        </div>
      </button>
      <button 
        ...
        <div className="flex flex-col items-center relative z-10 transition-all duration-300 group-hover:transform group-hover:translate-y-2">
          ...
          <p className="font-medium text-gray-800 group-hover:text-white transition-colors duration-300">Raw Material</p>
        </div>
      </button>
      <button 
        ...
        <div className="flex flex-col items-center relative z-10 transition-all duration-300 group-hover:transform group-hover:translate-y-2">
          ...
          <p className="font-medium text-gray-800 group-hover:text-white transition-colors duration-300">Fragrance</p>
        </div>
      </button>
      <button 
        ...
        <div className="flex flex-col items-center relative z-10 transition-all duration-300 group-hover:transform group-hover:translate-y-2">
          ...
          <p className="font-medium text-gray-800 group-hover:text-white transition-colors duration-300">Colors</p>
        </div>
      </button>
    </div>
  );
